        ...
        <section className="relative bg-gradient-to-br from-[#1D3F30] via-[#143728] to-[#1D3F30] text-white py-20 lg:py-28">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">{t.products.heroTitle} <span className="block text-accent">stake its reputation on.</span></h1>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-3 mb-6">
                    {shishaFeatures.map((feature, i) => (<li key={i} className="flex items-center gap-2 text-slate-600"><CheckCircle className="w-5 h-5 text-accent flex-shrink-0" />{feature}</li>))}
                  </ul>
              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-3 mb-6">
                    {bbqFeatures.map((feature, i) => (<li key={i} className="flex items-center gap-2 text-slate-600"><CheckCircle className="w-5 h-5 text-accent flex-shrink-0" />{feature}</li>))}
                  </ul>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl p-8 shadow-lg border-t-4 border-slate-400">
                ...
                <div className="text-3xl font-bold text-accent mb-6">Ash 2.2% - 2.5%</div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border-t-4 border-accent transform scale-105">
                <div className="bg-accent text-white text-xs font-bold px-3 py-1 rounded-full inline-block mb-2">{t.products.popular || "MOST POPULAR"}</div>
                ...
                <div className="text-3xl font-bold text-accent mb-6">Ash 1.9% - 2.2%</div>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border-t-4 border-accent">
                ...
                <div className="text-3xl font-bold text-accent mb-6">Ash 1.6% - 1.9%</div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center gap-3"><Shield className="w-6 h-6 text-accent" /><span className="text-slate-700">{t.products.oem1 || "Full confidentiality & NDA"}</span></li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-6 h-6 text-accent" /><span className="text-slate-700">{t.products.oem2 || "Custom box design support"}</span></li>
                  <li className="flex items-center gap-3"><CheckCircle className="w-6 h-6 text-accent" /><span className="text-slate-700">{t.products.oem3 || "Multiple packaging options"}</span></li>
                </ul>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#1D3F30] to-[#143728] rounded-2xl p-8 md:p-12 text-center text-white">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://wa.me/62881024922133" className="bg-accent hover:bg-accent/90 text-white font-semibold px-8 py-3 rounded-lg transition-colors">{t.common.getSample}</a>
