        ...
        <section className="relative bg-gradient-to-br from-[#1D3F30] via-[#143728] to-[#1D3F30] text-white py-20 lg:py-28">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">{t.quality.title} <span className="block text-accent">{t.quality.subtitle}</span></h1>
              <p className="text-xl text-slate-300 mb-8">{t.quality.qcProcessDesc}</p>
              <div className="flex flex-wrap justify-center gap-4">
                <a href="#process" className="bg-accent hover:bg-accent/90 text-white font-semibold px-8 py-3 rounded-lg transition-colors">{t.quality.viewQC}</a>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-3"><TestTube className="w-5 h-5 text-accent" /><span className="text-slate-700">{t.quality.ashContent}</span></li>
                  <li className="flex items-center gap-3"><TestTube className="w-5 h-5 text-accent" /><span className="text-slate-700">{t.quality.moisture}</span></li>
                  <li className="flex items-center gap-3"><TestTube className="w-5 h-5 text-accent" /><span className="text-slate-700">{t.quality.fixedCarbon}</span></li>
                  <li className="flex items-center gap-3"><TestTube className="w-5 h-5 text-accent" /><span className="text-slate-700">{t.quality.calorific}</span></li>
                </ul>
              </div>
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <a href="/export" className="inline-flex items-center gap-2 bg-accent hover:bg-accent/90 text-white font-semibold px-8 py-3 rounded-lg transition-colors">{t.quality.thirdPartyCTA} <ChevronRight className="w-5 h-5" /></a>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-slate-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-accent to-accent rounded-2xl p-8 md:p-12 text-center text-white">
              ...
              <a href="https://wa.me/62881024922133" className="inline-block bg-white text-accent font-semibold px-8 py-3 rounded-lg hover:bg-slate-100 transition-colors">{t.quality.requestReports}</a>
            </div>
          </div>
        </section>
      </div>
