        ...
        <section className="relative bg-gradient-to-br from-slate-800 via-slate-700 to-slate-900 text-white py-20 lg:py-28">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">BBQ Coconut Charcoal <span className="block text-accent">Premium Grilling Fuel</span></h1>
              <p className="text-xl text-slate-300 mb-8">High-quality coconut shell charcoal for professional grilling.</p>
              <div className="flex flex-wrap justify-center gap-4">
                <a href="#specs" className="bg-accent text-white font-semibold px-8 py-3 rounded-lg hover:bg-accent/90 transition-colors">View Specifications</a>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <ul className="space-y-4">
                  {features.map((feature, index) => (<li key={index} className="flex items-start gap-3"><CheckCircle className="w-6 h-6 text-accent flex-shrink-0 mt-0.5" /><span className="text-slate-700">{feature}</span></li>))}
                </ul>
              </div>
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <a href="/oem" className="inline-flex items-center gap-2 bg-accent hover:bg-accent/90 text-white font-semibold px-8 py-3 rounded-lg transition-colors">Learn About OEM <ChevronRight className="w-5 h-5" /></a>
            </div>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-accent to-accent rounded-2xl p-8 md:p-12 text-center text-white">
              ...
              <a href="https://wa.me/62881024922133" className="inline-block bg-white text-accent font-semibold px-8 py-3 rounded-lg hover:bg-slate-100 transition-colors">Get Quote via WhatsApp</a>
            </div>
          </div>
        </section>
      </div>
