        ...
        <section className="py-16 bg-slate-50">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-md text-center"><MapPin className="w-10 h-10 text-accent mx-auto mb-3" /><h3 className="font-semibold text-slate-900 mb-2">{t.contact.factoryLocation || "Factory Location"}</h3><p className="text-slate-600 text-sm">Majalengka & Bekasi, West Java, Indonesia</p></div>
