  ...
  return (
    <>
      ...
      <div ref={ref}>
        <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-20 lg:py-28">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">{t.export.title} <span className="block text-amber-500">{t.export.subtitle}</span></h1>
              <p className="text-xl text-slate-300 mb-8">{t.export.cta}</p>
              <div className="flex flex-wrap justify-center gap-4">
                <a href="#shipping" className="bg-amber-500 hover:bg-amber-600 text-white font-semibold px-8 py-3 rounded-lg transition-colors">{t.export.viewShipping}</a>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16"><Clock className="w-12 h-12 text-amber-500 mx-auto mb-4" /><h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">{t.export.prodTime}</h2></div>
            <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-8">
              <div className="flex justify-between items-center py-4 border-b border-slate-100"><span className="text-slate-700 font-medium">{t.export.fcl} ({t.export.fclDesc})</span><span className="text-amber-600 font-semibold">10-14 days</span></div>
        ...
        <section className="py-20 bg-slate-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12"><MapPin className="w-12 h-12 text-amber-500 mx-auto mb-4" /><h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">{t.export.loadingPort}</h2></div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16"><CreditCard className="w-12 h-12 text-amber-500 mx-auto mb-4" /><h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">{t.export.payment}</h2></div>
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12"><FileText className="w-12 h-12 text-amber-500 mx-auto mb-4" /><h2 className="text-3xl md:text-4xl font-bold mb-4">{t.export.docs}</h2></div>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="text-center"><div className="text-4xl font-bold text-amber-600 mb-2">18 tons</div><p className="text-slate-600">{t.export.fcl} ({t.export.fclDesc})</p></div>
        ...
        <section className="py-20 bg-amber-500">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://wa.me/62881024922133" className="bg-white text-amber-600 font-semibold px-8 py-3 rounded-lg hover:bg-slate-100 transition-colors">{t.export.getQuote}</a>
                <a href="/contact" className="border-2 border-white text-white hover:bg-white hover:text-amber-600 font-semibold px-8 py-3 rounded-lg transition-colors">{t.export.contactSales}</a>
              </div>
            </div>
          </div>
        </section>
